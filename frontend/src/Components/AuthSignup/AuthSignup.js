...
function AuthSignup() {
  ...
  const user = useSelector((state) => state.user.user); // using Redux
  ...
  let SignupValidation = (e) => {
    if (!userName) {
      setNotValidName("Enter valid data ❗");
      return;
    }
    if (!userEmail) {
      setNotValidEmail("Enter valid data ❗");
      return;
    }
    ...
    if (!userPassword) {
      setNotValidPassword("Enter valid data ❗");
      return;
    }
  ...
  let loginValidation = (e) => {
    if (!loginEmail) {
      setLoginEmailCheck("Enter valid data ❗");
      return;
    }
    ...
    if (!loginPassword) {
      setLoginPasswordCheck("Enter valid data ❗");
      return;
    }
    loginSubmitHandle(e);
  };
        ...
        <div className="container">
          <div className="title">
            <div
              ...
              style={
                formType === "signup" ? { borderBottom: "2px solid red" } : {}
              }
            ...
            <div
              ...
              style={
                formType === "login" ? { borderBottom: "2px solid red" } : {}
              }
          ...
          >
            ...
            <button className="submit-btn" onClick={(e) => SignupValidation(e)}>
              SignUp
            </button>
          </form>
          <form
            className="form" //for login
          ...
          >
            ...
            <div className="div">
              <input
                ...
                name="loginpassword"
                placeholder={
                  loginPasswordCheck ? loginPasswordCheck : "password"
                }
                value={loginPassword}
                onChange={(e) => {
            ...
            <button className="submit-btn" onClick={(e) => loginValidation(e)}>
              Login
            </button>
          </form>
        </div>
